...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-dark fixed-top flex-md-nowrap p-0 shadow" style ="background-color:blueviolet">
            <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="studentProfile.php"><i class="fa-brands fa-dashcube"></i> digiLearning</a>
        </nav>
