...
<div class="container-mt-5 ml-4">
    <div class="row">
        <div class="jumbotron">
            <h4 class="text-center"><i class="fa-brands fa-discourse"></i> All Course</h4>
            <?php 
            if(isset($stuLogEmail)){
                $sql="SELECT e.e_id,c.course_id,c.course_name,c.course_duration,c.course_desc,
                c.course_img,c.course_author,c.course_original_price,c.course_price FROM enroll AS e JOIN
                course AS c ON c.course_id = e.course_id WHERE e.stu_email= '$stuEmail'";
