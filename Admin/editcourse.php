...
if(isset($_REQUEST['requpdate'])){
    ...
    ($_REQUEST['course_duration'] == "") ||($_REQUEST['course_price'] == "") ||($_REQUEST['course_original_price'] == "")){
        ...
        course_price='$cprice',course_original_price='$coriginalprice',course_img='$cimg' WHERE course_id='$cid'";
...
<div class="col-sm-6 mt-5 mx-3 jumbotron">
    <h3 class="text-center">Update Course Details <i class="fa-solid fa-folder-open"></i></h3>
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="course_desc" name="course_desc" row=2 value="<?php if(isset($row['course_desc'])){echo $row['course_desc']; }?>"></textarea>
        </div>
        <div class="form-group">
