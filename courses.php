...
<div class="container mt-5">
        <h1 class="text-container"style="text-align:center;">All Courses</h1>
        <div class="row mt-4">
        <?php 
            ...
            if($result->num_rows >0){
                while($row = $result->fetch_assoc()){
                    ...
                    <div class="col-sm-4 mb-4">
                        <a href="coursedetails.php?course_id='.$course_id.'" class="btn" style="text-align:left; padding: 0px; magrin:0px;">
                            <div class="card bg-light mb-3 border-light mb-3">
